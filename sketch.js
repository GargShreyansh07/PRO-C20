...
function setup(){
    ...
    block3 = Bodies.rectangle(250,475,150,20,plane_options);
    ...
    particle7 = Bodies.circle(225,10,10,particle_options);
    World.add(world,particle7);
    particle8 = Bodies.circle(225,10,10,particle_options);
    World.add(world,particle8);
    particle9 = Bodies.circle(226,10,10,particle_options);
